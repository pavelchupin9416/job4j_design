...
public class ConfigTest {
    ...
    public void whenPairWithIllegalArgumentKey() {
        String path ="./data/test_key.properties";
        Config config = new Config(path);
        config.load();
    ...
    public void whenPairWithIllegalArgumentValue()  {
        String path ="./data/test_value.properties";
        Config config = new Config(path);
        config.load();
    ...
    public void whenPairWithIllegalArgumentNotEquals() {
        String path ="./data/test_not_equals.properties";
        Config config = new Config(path);
        config.load();
    ...
    public void whenPairWithIllegalArgument() {
        String path ="./data/test_argument.properties";
        Config config = new Config(path);
        config.load();
